...
<%@page import="Grooming.model.Customer"%>
               ...
               if (cartList != null && cart.getCount() != 0)  {%>
                ...
                <table class="Table">
                    ...
                    <tr>
                        ...
                        <td><%double roundO = (double) (Math.round(cartList.get(p).getTotal() * 100.0) / 100.0);%>
                            $<%=roundO%>
                    ...
                    <tr>
                        ...
                        <td><%double roundOf = (double) (Math.round(cartTotal * 100.0) / 100.0);%>
                            $<%=roundOf%>
                        </td>
                    </tr>
                    <tr>
