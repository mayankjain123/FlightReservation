...
<%@page import="Grooming.model.Ticket"%>
            ...
            <div class="bodytext">
                ...
                <form action="OrderController" method="GET">
                    <table class="Table">
                        ...
                        <tr>
                            <td>
                                <%=cartList.get(p).getFlight().getFlightID()%>&nbsp;-&nbsp;<%=cartList.get(p).getFlight().getSource()%>&nbsp;-&nbsp;<%=cartList.get(p).getFlight().getDestination()%>
                            ...
                            <td><%double roundTotal = (double) (Math.round(cartList.get(p).getTotal() * 100.0) / 100.0);%>
                                $<%=roundTotal%>
                        ...
                        <tr>
                            ...
                            <td><%double roundOff = (double) (Math.round(cartTotal * 100.0) / 100.0);%>
                                $<%=roundOff%>
                            </td>
                        </tr>
                        <%} %>
